...
export const deleteDonationDetailsOfUser: APIGatewayProxyHandler = async (event: APIGatewayProxyEvent & Body, _context) => {
...
export const handler = middy(deleteDonationDetailsOfUser)
